...
### Ask me anything!
- Who made this?  
    This is the [pi-apps-go team](https://github.com/pi-apps-go), a team who rewrites many of Pi-Apps apps/utilities in the [Go](https://go.dev) programming language for speed and is the founder of [Pi-Apps Go](https://github.com/pi-apps-go/pi-apps). The team (only 1 person for now) has had drama lately and in need of financial support. [Read more here.](https://github.com/sponsors/matu6968)  
- Is this legal?  
